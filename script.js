...
const GOOGLE_API_KEY = "AIzaSyAyhYN5kdePWA-IJDrpa5w-eQyQQ13zzOs"; // Replace with your valid API key
const MODEL_NAME = "gemini-1.5-flash"; // Or "gemini-2.0-pro" or "gemini-2.0-flash" if available to you
const API_REQUEST_URL = `https://generativelanguage.googleapis.com/v1/models/${MODEL_NAME}:generateContent?key=${GOOGLE_API_KEY}`;
